...
alias gemini="ssh Gemini -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
...
alias voyager="ssh Voyager -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
# alias Voyager="ssh Voyager -t '/opt/homebrew/bin/tmux -CC attach || /opt/homebrew/bin/tmux -CC'"
# alias magellan="ssh -J voyager Magellan -t 'tmux -CC attach || tmux -CC'"
alias magellan="ssh Magellan -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
...
alias apollo="ssh Apollo -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
# alias Apollo="ssh Apollo -t 'tmux -CC attach || tmux -CC'"
# alias atlas="ssh -J voyager Atlas -t 'tmux -CC attach || tmux -CC'"
alias atlas="ssh Atlas -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
