...
alias gemini="tailscale ssh gemini -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
...
alias voyager="ssh voyager -t 'TERM=xterm-256color /opt/homebrew/bin/tmux attach || TERM=xterm-256color /opt/homebrew/bin/tmux new'"
# alias Voyager="ssh Voyager -t '/opt/homebrew/bin/tmux -CC attach || /opt/homebrew/bin/tmux -CC'"
# alias magellan="ssh -J voyager Magellan -t 'tmux -CC attach || tmux -CC'"
alias magellan="tailscale ssh magellan -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
...
alias apollo="tailscale ssh apollo -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
# alias Apollo="ssh Apollo -t 'tmux -CC attach || tmux -CC'"
# alias atlas="ssh -J voyager Atlas -t 'tmux -CC attach || tmux -CC'"
alias atlas="tailscale ssh atlas -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
# alias Atlas="ssh Atlas -t 'tmux -CC attach || tmux -CC'"
# alias aeropoint="ssh aeropoint -t '/usr/bin/tmux -CC attach || /usr/bin/tmux -CC'"
alias aeropoint="ssh aeropoint -t 'TERM=xterm-256color tmux attach || TERM=xterm-256color tmux new'"
